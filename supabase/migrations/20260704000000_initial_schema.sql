-- Initial Phase 1 schema, taken verbatim from context/DATA_MODEL.sql (authoritative).
-- If this file and DATA_MODEL.sql ever diverge, DATA_MODEL.sql wins — update via a new migration.
